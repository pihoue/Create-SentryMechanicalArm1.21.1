...
public class ModCodecs {
   ...
   public static final StreamCodec<RegistryFriendlyByteBuf, Vec3> VEC3_STREAM_CODEC_REGISTRY = new StreamCodec<RegistryFriendlyByteBuf, Vec3>() {
   ...
   public static final StreamCodec<FriendlyByteBuf, CompoundTag> COMPOUND_TAG_CODEC = new StreamCodec<FriendlyByteBuf, CompoundTag>() {
